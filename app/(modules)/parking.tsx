...
export default function ParkingAssistant() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: themeColors.background }]}>
      <Header title="Parking Assistant" />
      <ScrollView contentContainerStyle={styles.content}>
        <GlassCard style={styles.card}>
          <MaterialIcons
            ...
            style={styles.icon}
          />
          <Text style={[styles.title, { color: themeColors.text }]}>Find Your Spot</Text>
          <Text style={[styles.subtitle, { color: themeColors.icon }]}>
            Your reserved spot is P4-12B. Turn-by-turn navigation is available.
          </Text>
        </GlassCard>
      </ScrollView>
    </View>
