...
export default function MultilingualGuide() {
  ...
  return (
    <View style={[styles.container, { backgroundColor: themeColors.background }]}>
      <Header title="Multilingual Guide" />
      <ScrollView contentContainerStyle={styles.content}>
        <GlassCard style={styles.card}>
          <MaterialIcons name="language" size={48} color={themeColors.tint} style={styles.icon} />
          <Text style={[styles.title, { color: themeColors.text }]}>Real-time Translation</Text>
          <Text style={[styles.subtitle, { color: themeColors.icon }]}>
            Translate stadium announcements and signage instantly using your camera or mic.
          </Text>
        </GlassCard>
      </ScrollView>
    </View>
